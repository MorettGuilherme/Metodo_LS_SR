...
1) Função para o cálculo da estatística do erro de estimação da amplitude, fase ou pedestal pelo método LS sem restrição.
Entrada: vetor com os erros de estimação da amplitude, fase ou pedestal.
Saída: a média, a variância e o desvio padrão do erro de estimação da amplitude, fase ou pedestal.

2) Instrução para o plote do histograma do tipo A do erro de estimação da amplitude, fase ou pedestal pelo método LS sem restrição.
Entrada: vetor com os erros de estimação da amplitude, fase ou pedestal e seus dados estatísticos.
Saída: nada.

3) Instrução para o plote do histograma do tipo B do erro de estimação da amplitude, fase ou pedestal pelo método LS sem restrição.
Entrada: número de ocupação, parâmetro, vetor com os erros de estimação da amplitude, fase ou pedestal e seus dados estatísticos para os janelamento 7, 15 e 19.
Saída: nada.
...
titulo_programa = colored("Análise do erro de estimação da amplitude, fase ou pedestal pelo Método Mínimos Quadrados Sem Restrição (LS):\n", attrs=["bold"])
...
# Definição de instrução para o plot do histograma do tipo A do erro de estimação da amplitude, fase ou pedestal pelo método LS sem restrição.
def histograma_A_erro_estimacao_parametro_LS_SR(n_ocupacao, parametro, vetor_erro_estimacao_parametro, media_erro_estimacao_parametro, var_erro_estimacao_parametro, desvio_padrao_erro_estimacao_parametro):
...
# Definição de instrução para o plot dos histogramas do tipo B do erro de estimação da amplitude, fase ou pedestal para diferentes janelamentos para uma dada ocupação pelo método LS sem restrição.
def histograma_B_erro_estimacao_parametro_LS_SR(n_ocupacao, parametro, vetor_erro_estimacao_parametro_J7, media_erro_estimacao_parametro_J7, var_erro_estimacao_parametro_J7, desvio_padrao_erro_estimacao_parametro_J7, vetor_erro_estimacao_parametro_J15, media_erro_estimacao_parametro_J15, var_erro_estimacao_parametro_J15, desvio_padrao_erro_estimacao_parametro_J15, vetor_erro_estimacao_parametro_J19, media_erro_estimacao_parametro_J19, var_erro_estimacao_parametro_J19, desvio_padrao_erro_estimacao_parametro_J19):
    ...
    # Caso a variável parametro seja igual a "fase".
    elif parametro == "fase":
...
def principal_histograma_erro_estimacao_parametro_LS_SR():
    ...
    if n_ocupacao not in valores_ocupacao or isinstance(parametro, str):
    ...
    if tipo_histograma == "A":
        ...
        vetor_erro_estimacao_parametro = metodo_LS_SR(n_janelamento, Matriz_Pulsos_Sinais_Treino_Janelado, Matriz_Pulsos_Sinais_Teste_Janelado, vetor_parametro_referencia_treino_janelado, vetor_parametro_referencia_teste_janelado)

        media_erro_estimacao_parametro, var_erro_estimacao_parametro, desvio_padrao_erro_estimacao_parametro = dados_estatisticos_erro_estimacao_parametro_LS_SR(vetor_erro_estimacao_parametro)
    
        histograma_A_erro_estimacao_parametro_LS_SR(n_ocupacao, parametro, vetor_erro_estimacao_parametro, media_erro_estimacao_parametro, var_erro_estimacao_parametro, desvio_padrao_erro_estimacao_parametro)
    ...
    # Caso a variável tipo_histograma seja "B".
        ...
        # Caso a variável parametro seja igual a 3.
            ...
            vetor_pedestal_referencia = np.random.uniform(10, 50, len(Matriz_Dados_OC))
        ...
        vetor_erro_estimacao_parametro_J7 = metodo_LS_SR(n_janelamento_J7, Matriz_Pulsos_Sinais_Treino_Janelado_J7, Matriz_Pulsos_Sinais_Teste_Janelado_J7, vetor_parametro_referencia_treino_janelado_J7, vetor_parametro_referencia_teste_janelado_J7)
        media_erro_estimacao_parametro_J7, var_erro_estimacao_parametro_J7, desvio_padrao_erro_estimacao_parametro_J7 = dados_estatisticos_erro_estimacao_parametro_LS_SR(vetor_erro_estimacao_parametro_J7)
    
        vetor_erro_estimacao_parametro_J15 = metodo_LS_SR(n_janelamento_J15, Matriz_Pulsos_Sinais_Treino_Janelado_J15, Matriz_Pulsos_Sinais_Teste_Janelado_J15, vetor_parametro_referencia_treino_janelado_J15, vetor_parametro_referencia_teste_janelado_J15)
        media_erro_estimacao_parametro_J15, var_erro_estimacao_parametro_J15, desvio_padrao_erro_estimacao_parametro_J15 = dados_estatisticos_erro_estimacao_parametro_LS_SR(vetor_erro_estimacao_parametro_J15)
    
        vetor_erro_estimacao_parametro_J19 = metodo_LS_SR(n_janelamento_J19, Matriz_Pulsos_Sinais_Treino_Janelado_J19, Matriz_Pulsos_Sinais_Teste_Janelado_J19, vetor_parametro_referencia_treino_janelado_J19, vetor_parametro_referencia_teste_janelado_J19)
        media_erro_estimacao_parametro_J19, var_erro_estimacao_parametro_J19, desvio_padrao_erro_estimacao_parametro_J19 = dados_estatisticos_erro_estimacao_parametro_LS_SR(vetor_erro_estimacao_parametro_J19)
