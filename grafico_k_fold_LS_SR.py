...
titulo_programa = colored("Plote do gráfico da validação cruzada K-Fold para o Método dos Mínimos Quadrados Sem Restrição (LS) para a estimação da amplitude, fase ou pedestal:\n", attrs=["bold"])
...
def leitura_dados_estatisticos_k_fold_LS_SR(parametro, n_ocupacao, dado_estatistico):
    ...
    pasta_dados_k_fold = f"K_Fold_{parametro}_{dado_estatistico}_Dados_Estatisticos_LS_SR_OC"

    # Nome do arquivo de entrada dos dados estatísticos do K-Fold.
    arquivo_dados_k_fold = f"k_fold_{parametro}_{dado_estatistico}_dados_estatisticos_LS_SR_OC_{n_ocupacao}.txt"
...
def principal_grafico_k_fold_LS_SR():
    ...
    Matriz_Dados_K_Fold_OC_0 = leitura_dados_estatisticos_k_fold_LS_SR(parametro, 0, dado_estatistico)
    Matriz_Dados_K_Fold_OC_10 = leitura_dados_estatisticos_k_fold_LS_SR(parametro, 10, dado_estatistico)
    Matriz_Dados_K_Fold_OC_20 = leitura_dados_estatisticos_k_fold_LS_SR(parametro, 20, dado_estatistico)
    Matriz_Dados_K_Fold_OC_30 = leitura_dados_estatisticos_k_fold_LS_SR(parametro, 30, dado_estatistico)
    Matriz_Dados_K_Fold_OC_40 = leitura_dados_estatisticos_k_fold_LS_SR(parametro, 40, dado_estatistico)
    Matriz_Dados_K_Fold_OC_50 = leitura_dados_estatisticos_k_fold_LS_SR(parametro, 50, dado_estatistico)
    Matriz_Dados_K_Fold_OC_60 = leitura_dados_estatisticos_k_fold_LS_SR(parametro, 60, dado_estatistico)
    Matriz_Dados_K_Fold_OC_70 = leitura_dados_estatisticos_k_fold_LS_SR(parametro, 70, dado_estatistico)
    Matriz_Dados_K_Fold_OC_80 = leitura_dados_estatisticos_k_fold_LS_SR(parametro, 80, dado_estatistico)
    Matriz_Dados_K_Fold_OC_90 = leitura_dados_estatisticos_k_fold_LS_SR(parametro, 90, dado_estatistico)
    Matriz_Dados_K_Fold_OC_100 = leitura_dados_estatisticos_k_fold_LS_SR(parametro, 100, dado_estatistico)
    
    # Caso a variável tipo_grafico seja "A".
    if tipo_grafico == "A":
        
        # Chamada da função grafico_A_k_fold_LS_SR.
        grafico_A_k_fold_LS_SR(parametro, opcao_dado_estatistico, Matriz_Dados_K_Fold_OC_0, Matriz_Dados_K_Fold_OC_10, Matriz_Dados_K_Fold_OC_20, Matriz_Dados_K_Fold_OC_30, Matriz_Dados_K_Fold_OC_40, Matriz_Dados_K_Fold_OC_50, Matriz_Dados_K_Fold_OC_60, Matriz_Dados_K_Fold_OC_70, Matriz_Dados_K_Fold_OC_80, Matriz_Dados_K_Fold_OC_90, Matriz_Dados_K_Fold_OC_100)
